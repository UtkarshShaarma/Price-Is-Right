...
class DealAgentFramework:
    ...
    def get_plot_data(cls, max_datapoints=10000):
        ...
        # Extract vectors, documents and categories
        ...
        # else:
        #     # Scale perplexity with dataset size, but keep it well below n_samples
        #     perplexity = min(30, n_samples // 3)
        # 
        # # Create and configure t-SNE
        try:
            tsne = TSNE(
                n_components=3,  # Keeping your 3 components setting
                # perplexity=perplexity,
                random_state=42,
                n_jobs=-1  # Keeping your parallel processing setting
            )
            ...
            print(f"Number of samples: {n_samples}, Attempted perplexity: {perplexity}")
            # Fallback: return simple 3D coordinates if t-SNE fails
            reduced_vectors = np.random.rand(len(vectors), 3)
